    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Daftar fotocopy</h1>
            </div>
            <div>
                <table>
                    <tr>
                ...
                <div class="col">
                    <table id="tabel" class="display nowrap" style="width:100%">
                        ...
                        <tbody id="tbody" name="tbody" style="color: black;">
                            <?php if (isset($fotocopy) && !empty($fotocopy)): ?>
                                <?php foreach ($fotocopy as $row): ?>
                                    <tr>
                                        <td><?= $row['id_fc']; ?></td>
                                        <td><?= $row['nomor']; ?></td>
                                        <td><?= $row['id_barang']; ?></td>
                                            ...
                                            <ul class="list-inline m-0">
                                                ...
                                                <li class="list-inline-item">
                                                    <button class="btn btn-success btn-sm rounded-0" data-toggle="tooltip"
                                                        title="Edit" data-id_fc="<?= $row['id_fc'] ?>"
                                                        data-nama="<?= $row['nomor'] ?>" data-alamat="<?= $row['id_barang'] ?>"
                                                        data-telepon="<?= $row['harga_total'] ?>" data-toggle="modal"
                                                ...
                                                <!-- Tombol Hapus -->
                                                <li class="list-inline-item">
                                                    <form action="<?= base_url('FcController/hapusData'); ?>" method="post"
                                                        style="display: inline;">
                                                        <input type="hidden" name="id_fc" value="<?= $row['id_fc']; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahDataLabel">Tambah Data fotocopy</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= site_url('FcController/tambahData') ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="telepon" name="telepon"
                            placeholder="Masukkan id_fc telepon" required>
                    </div>
                </div>
...
<div class="modal fade" id="modalEditData" tabindex="-1" role="dialog" aria-labelledby="modalEditDataLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditDataLabel">Edit Data fotocopy</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('FcController/update') ?>" method="POST">
                <div class="modal-body">
                    <!-- Hidden field for ID or id_fc -->
                    <input type="hidden" id="id_fc" name="id_fc" required>
...
<div class="modal fade" id="detailModal" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><strong>id_fc:</strong> <span id="detailid_fc"></span></p>
